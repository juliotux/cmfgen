C
C Subroutine to convert from the default units (10^15 Hz, Jy) to other
C units: Current options are:
C        For X axis:  Ang, um, 10^15 Hz, ev, keV, km/s, Mm/s (and Log)
C        For Y axis:  Jy, vF(v), Flam (and Log0
C
