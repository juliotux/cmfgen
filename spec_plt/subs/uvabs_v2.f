...
C
	subroutine uvabs_v2(origfreq,origflux,Norig,Norig_max,
     1                   t_in_k,v_turb,log_ntot,log_h2_ntot,
     1                   v_r,min_res_kms,wave_max,wave_min,
     1                   hi_abs,h2_abs,is_file)
	implicit none
!
! Altered: 12-Mar-2015 : Changed to v2. is_file added to call. Now call is_line_abs_v2 (9-June-2015) 
!
...
C       same spacing in lambda as the model data.
	...
	call is_line_abs_v2(Hwave,Hflux,Ntmp,v_turb,log_h2_ntot,t_in_k,is_file)
!
	write(6,*)'Done IS abs'
