...
C
C Typicall they will be CHI_C, and ETA_C, CHIL_, AND ETAL of othe lines.
C
...
C JNU and r^2 HNU.
C
	SUBROUTINE VAR_MOM_J_CMF_V6(ETA,CHI,ESEC,V,SIGMA,R,
...
C
C WORKMAT is dimension (ND,ND) is is used to temporaily save TX( , ,K) for
C each K.
C
	CALL TUNE(1,'UP_TX')
