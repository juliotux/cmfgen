...
C                          niw used for these variables.
C
	SUBROUTINE SOLVEBA_V2(BA,STEQ,TBA,POPS,
	1   DIAG_IND,NT,NUM_BNDS,ND,
	1   REPA,MATELIM,MAXCH,METH_SOL,
	1   SUCCESS,SCALE_OPT,CHANGE_LIM)
	IMPLICIT NONE
C
...
9200	FORMAT(1X,'Maximum % decrease at depth ',I3,' is',1PE10.2)
C
