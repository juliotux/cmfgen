...
!
	...
	REAL*8, ALLOCATABLE :: JQW(:)
	REAL*8, ALLOCATABLE :: HQW(:)
	REAL*8, ALLOCATABLE :: KQW(:)
	REAL*8, ALLOCATABLE :: NQW(:)
!
...
!
	...
	REAL*8 ESEC(ND)
!
	REAL*8 JNU(ND),HNU(ND),KNU(ND),NNU(ND),N_ON_J(ND)
	REAL*8 IN_HBC,HBC,HBC_INCID,NBC,NBC_INCID
	REAL*8 IPLUS_P(NP)
!
