...
!
	...
	CHARACTER(LEN=*) DESC
!
	REAL*8 SIG_GAU_KMS		!V[FWHM]=2.34 SIG_AU_KMS
	REAL*8 FRAC_SIG_GAU             !Spacing in smoothed cross section
	REAL*8 CUT_ACCURACY		!Accuracy to delete superflous data points
...
!
	INTEGER NPNTS_TOT
	INTEGER N_CROSS
	INTEGER, PARAMETER :: N_CROSS_MAX=100000
